...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        $mform->addElement('text', 'username', 'CPF', 'minlenght="14" maxlength="14" size="14" autocapitalize="none"');
        ...
        $mform->addElement('static', 'passwordpolicyinfo', '', 'Não devem ser utilizados endereços de e-mail do Hotmail, Outlook');
        ...
        $mform->addRule('city', 'Preencha o campo cidade/município', 'required', null, 'client');
    ...
    public function validation($data, $files)  {
        ...
        if (strlen($cpf) != 11) {
            $errors += ["username" => "CPF inválido, digite todos dígitos"];
        }

        // Verifica se foi informada uma sequencia de digitos repetidos. Ex: 111.111.111-11
        if (preg_match('/(\d)\1{10}/', $cpf)) {
            $errors += ["username" => "CPF inválido, números repetidos"];
        }
