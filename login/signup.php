...
<div class="alert alert-danger" role="alert">
    <i class="fa fa-bell fa-fw fa-2x" title="Alternar menu de notificações" role="img" aria-label="Alternar menu de notificações"></i>
    Atenção: Apenas o cadastro no Moodle não efetiva a inscrição no processo seletivo. Após criar sua conta, faça login com CPF e senha nesta página e preencha o formulário de inscrição.
</div>

<div class="alert alert-primary" role="alert">
    <i class="fa fa-file-pdf-o fa-2x" title="Alternar menu de notificações" role="img" aria-label="Alternar menu de notificações"></i>
    <a href="../public/tutorial.pdf" target="_blank">
        Passo a passo para inscrição - estágio de graduação
...
echo '<script type="text/javascript" src="mask.js?ver=1.0"></script>';
