...
$url = new moodle_url('/blocks/inscricao/inscricoes/nao_analizadas/view.php');
$PAGE->set_url($url);
$PAGE->set_pagelayout('standard');
$PAGE->set_title('Inscrições Realizadas - Não Analisadas');
$PAGE->set_heading('Inscrições Realizadas - Não Analisadas');
...
echo '<h3 class="bg-warning p-3">Não Analisadas</h3>';
