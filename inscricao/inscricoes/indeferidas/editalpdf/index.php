...
<!doctype html>
  ...
  <head>
  <meta charset="UTF-8">
  <title>INSCRIÇÕES REALIZADAS - INDEFERIDAS</title>
...
foreach ($inscricaodb as &$val) {
  $html .= '
    <tr>
      ...
      <td class="tdb" align="center">' . $val->motivo_indeferimento. '</td>
    </tr>
    ';
}
...
$dompdf->render();
$dompdf->stream('Inscrições Realizadas - Indeferidas');
