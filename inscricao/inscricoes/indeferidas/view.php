...
$url = new moodle_url('/blocks/inscricao/inscricoes/indeferidas/view.php');
$PAGE->set_url($url);
$PAGE->set_pagelayout('standard');
$PAGE->set_title('Inscrições Realizadas - Indeferidas');
$PAGE->set_heading('Inscrições Realizadas - Indeferidas');
...
echo '<h3 class="bg-danger p-3">Indeferidas</h3>';
...
echo '<a class="btn btn-primary m-2" href="editalpdf/index.php?idcurso=' . $idcurso . '" role="button">Exportar PDF sem CPF <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>';
