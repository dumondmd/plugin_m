...
$url = new moodle_url('/blocks/inscricao/recursos/deferidos/view.php');
$PAGE->set_url($url);
$PAGE->set_pagelayout('standard');
$PAGE->set_heading('Recursos Realizados e Não Analisados');
$PAGE->set_title('Recursos Realizados e Não Analisados');
...
$editnode = $settingsnode->add('Confirmar Recurso');
$editnode->make_active();
echo $OUTPUT->header();


echo '<h3 class="bg-warning p-3">Não Analisados</h3>';
//echo '<h5>Exportar dados: </h5>';
//echo '<a href="#"><button type="button" class="btn btn-primary">PDF</button></a>';
//echo '<a href="#"><button type="button" class="btn btn-primary ml-2">XLS</button></a>';
...
function get_inscricoes($idcurso) {
    ...
    $inscricaodb = $DB->get_records_sql(
      '
      SELECT u.username as cpf, u.firstname, u.lastname, u.email, u.city, ue.timecreated AS applydate,
