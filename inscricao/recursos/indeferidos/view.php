...
$url = new moodle_url('/blocks/inscricao/recursos/indeferidos/view.php');
$PAGE->set_url($url);
$PAGE->set_pagelayout('standard');//Inscrições Realizadas - Indeferidas
$PAGE->set_heading('Recursos Realizados - Indeferidos');
$PAGE->set_title('Recursos Realizados - Indeferidos');
...
echo '<h3 class="bg-danger p-3">Indeferidos</h3>';
